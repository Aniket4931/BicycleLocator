...
def get_nearest_bicycles():
    ...
    if user_location:
        ...
        folium.Marker([user_latitude, user_longitude], popup="Your Location", icon=folium.Icon(color='red')).add_to(mymap)
        ...
        return jsonify({"error": "check your internet connection."})
